...
inline const ConnectorMap& GetChannelMap()
{
	...
	deckLinkIp100G[std::nullopt][0][NOS_DECKLINK_CHANNEL_SINGLE_LINK_1] = {NOS_MEDIAIO_DIRECTION_INPUT, NOS_MEDIAIO_DIRECTION_OUTPUT};
	deckLinkIp100G[std::nullopt][1][NOS_DECKLINK_CHANNEL_SINGLE_LINK_2] = {NOS_MEDIAIO_DIRECTION_INPUT, NOS_MEDIAIO_DIRECTION_OUTPUT};
	deckLinkIp100G[std::nullopt][2][NOS_DECKLINK_CHANNEL_SINGLE_LINK_3] = {NOS_MEDIAIO_DIRECTION_INPUT, NOS_MEDIAIO_DIRECTION_OUTPUT};
	deckLinkIp100G[std::nullopt][3][NOS_DECKLINK_CHANNEL_SINGLE_LINK_4] = {NOS_MEDIAIO_DIRECTION_INPUT, NOS_MEDIAIO_DIRECTION_OUTPUT};
	deckLinkIp100G[std::nullopt][4][NOS_DECKLINK_CHANNEL_SINGLE_LINK_5] = {NOS_MEDIAIO_DIRECTION_INPUT, NOS_MEDIAIO_DIRECTION_OUTPUT};
	deckLinkIp100G[std::nullopt][5][NOS_DECKLINK_CHANNEL_SINGLE_LINK_6] = {NOS_MEDIAIO_DIRECTION_INPUT, NOS_MEDIAIO_DIRECTION_OUTPUT};
	deckLinkIp100G[std::nullopt][6][NOS_DECKLINK_CHANNEL_SINGLE_LINK_7] = {NOS_MEDIAIO_DIRECTION_INPUT, NOS_MEDIAIO_DIRECTION_OUTPUT};
	deckLinkIp100G[std::nullopt][7][NOS_DECKLINK_CHANNEL_SINGLE_LINK_8] = {NOS_MEDIAIO_DIRECTION_INPUT, NOS_MEDIAIO_DIRECTION_OUTPUT};
